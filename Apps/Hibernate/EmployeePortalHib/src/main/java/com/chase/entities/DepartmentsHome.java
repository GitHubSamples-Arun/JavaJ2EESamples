package main.java.com.chase.entities;
// Generated May 4, 2017 12:02:12 AM by Hibernate Tools 5.2.1.Final
...
public class DepartmentsHome {
	...
	public List findByExample(Departments instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Departments")
